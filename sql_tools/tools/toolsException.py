"""
Exceptions for SQL-Tools (tools) library.
"""

class QueryError(Exception):
    """
    Query exception for SQL-Tools (tools).
    """
...
class PathError(Exception):
    """
    Path exception for SQL-Tools (tools).
    """
...
class MatrixError(Exception):
    """
    Matrix exception for SQL-Tools (tools).
    """
    def __init__(self, message="Error in path provided."):
...
class CommandError(Exception):
    """
    Command exception for SQL-Tools (tools).
    """
    def __init__(self, message="Error in path provided."):
...
class TableError(Exception):
    """
    Table exception for SQL-Tools (tools).
    """
...
class DatabaseError(Exception):
    """
    Database exception for SQL-Tools (tools).
    """
...
class SecurityError(Exception):
    """
    Security exception for SQL-Tools (tools).
    """
...
class ColumnError(Exception):
    """
    Column exception for SQL-Tools (tools).
    """
...
class JSONError(Exception):
    """
    JSON exception for SQL-Tools (tools).
    """
...
class SupportError(Exception):
    """
    Support exception for SQL-Tools (tools).
    """
...
class DataError(Exception):
    """
    Data exception for SQL-Tools (tools).
    """
    def __init__(self, message="Data may have some problems."):
        super(UnknownError).__init__()

class UnknownError(Exception):
    """
    Unknown exception for SQL-Tools (tools).
    """
